          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex">
              ...
              <?php if(Auth::user()->is_admin==1): ?>
                <a href="<?php echo e(route('admin')); ?>"  class="btn btn-primary me-md-3" >Панель администратора</a>               
              <?php else: ?>
              <a href="<?php echo e(route('profile')); ?>"  class="btn btn-primary me-md-3" >Личный кабинет</a>
              <?php endif; ?>
              <a href="<?php echo e(route('logout')); ?>" class="btn btn-primary me-md-3" >Выход</a>
              <?php else: ?>
...
<?php /**PATH C:\OpenServer\domains\ilians\resources\views/layouts/main.blade.php ENDPATH**/ ?>